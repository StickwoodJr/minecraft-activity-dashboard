...
public class PlayerStatsHandler implements HttpHandler {
    ...
    public PlayerStatsHandler(StatsAggregator statsAggregator, UuidCache uuidCache) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        String prefix = "/api/player-stats/";
        ...
        Path baseStatsDir = FabricLoader.getInstance().getGameDir()
